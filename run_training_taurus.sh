...
python /scratch/p_kpml/playground_marvin/torch_coin.py $MODEL_TYPE -fc_hd $FC_HIDDEN_SIZE --save $SAVE_PATH -b $BATCH_SIZE -e $NUM_EPOCHS -p /scratch/p_kpml/playground_marvin/coin_data/data.hdf5 --val_split 0.2 --top_db $TOP_DB -hs $HIDDEN_SIZE -s 16 -c 4
